          ...
          <div className="flex flex-col gap-1.5 min-w-0 flex-1">
            ...
            <div className="flex items-center gap-1.5 text-xs text-foreground/70 w-full -mb-[2px] min-w-0">
              ...
              >
                ...
                {item.worktreeBranch && (
                  <span className="shrink-0 h-[18px] px-1.5 text-[10px] font-medium rounded bg-foreground/5 text-foreground/60 flex items-center whitespace-nowrap gap-0.5">
                    <svg className="h-[10px] w-[10px]" viewBox="0 0 16 16" fill="currentColor"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Z" /></svg>
                    {item.worktreeBranch.replace(/^agent\//, '')}
                  </span>
                )}
